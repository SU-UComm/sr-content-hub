...
var AllContent = function AllContent() {
  var _window, _window$data, _window$data$texts, _window$data$texts$al, _window2, _window2$data, _window2$data$texts, _window2$data$texts$n;
  ...
  return isLoading ? /*#__PURE__*/react.createElement(dist_module/* Oval */.iT, {
    ...
    headingText: (_window = window) === null || _window === void 0 ? void 0 : (_window$data = _window.data) === null || _window$data === void 0 ? void 0 : (_window$data$texts = _window$data.texts) === null || _window$data$texts === void 0 ? void 0 : (_window$data$texts$al = _window$data$texts.allcontent) === null || _window$data$texts$al === void 0 ? void 0 : _window$data$texts$al.headingText,
