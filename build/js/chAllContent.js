/******/ (function () {
    ...
    /******/ var __webpack_modules__ = {
        /***/ 3685: /***/ function (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
            ...
            var prop_types_default = /*#__PURE__*/ __webpack_require__.n(prop_types); // CONCATENATED MODULE: ./src/modules/Search/SearchBar.jsx
                                        ...
                                        statusOptions.map(function (option) {
                                            return /*#__PURE__*/ react.createElement(
                                                'li',
                                                {
                                                    ...
                                                    className:
                                                        'su-leading-[3.6rem] su-block su-text-18 su-mb-0 su-py-8 su-pl-15 su-pr-20 hover:su-cursor-pointer hover:su-bg-gray-light '.concat(
            ...
            var Card = __webpack_require__(832);
            // EXTERNAL MODULE: ./src/modules/Pagination/Pagination.jsx
            var Pagination = __webpack_require__(3729); // CONCATENATED MODULE: ./src/modules/Search/SearchBar.jsx
            function SearchBar_slicedToArray(arr, i) {
                return SearchBar_arrayWithHoles(arr) || SearchBar_iterableToArrayLimit(arr, i) || SearchBar_unsupportedIterableToArray(arr, i) || SearchBar_nonIterableRest();
            }

            function SearchBar_nonIterableRest() {
                throw new TypeError('Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.');
            }

            function SearchBar_unsupportedIterableToArray(o, minLen) {
                if (!o) return;
                if (typeof o === 'string') return SearchBar_arrayLikeToArray(o, minLen);
                var n = Object.prototype.toString.call(o).slice(8, -1);
                if (n === 'Object' && o.constructor) n = o.constructor.name;
                if (n === 'Map' || n === 'Set') return Array.from(o);
                if (n === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return SearchBar_arrayLikeToArray(o, minLen);
            }

            function SearchBar_arrayLikeToArray(arr, len) {
                if (len == null || len > arr.length) len = arr.length;
                for (var i = 0, arr2 = new Array(len); i < len; i++) {
                    arr2[i] = arr[i];
                }
            ...
            function SearchBar_iterableToArrayLimit(arr, i) {
                var _i = arr == null ? null : (typeof Symbol !== 'undefined' && arr[Symbol.iterator]) || arr['@@iterator'];
                if (_i == null) return;
                var _arr = [];
                var _n = true;
            ...
            function SearchBar_arrayWithHoles(arr) {
                if (Array.isArray(arr)) return arr;
            }
            ...
            var dist_module = __webpack_require__(6665); // CONCATENATED MODULE: ./src/modules/AllContent/AllContent.jsx
            ...
            function AllContent_slicedToArray(arr, i) {
                return AllContent_arrayWithHoles(arr) || AllContent_iterableToArrayLimit(arr, i) || AllContent_unsupportedIterableToArray(arr, i) || AllContent_nonIterableRest();
            }

            function AllContent_nonIterableRest() {
                throw new TypeError('Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.');
            }

            function AllContent_unsupportedIterableToArray(o, minLen) {
                if (!o) return;
                if (typeof o === 'string') return AllContent_arrayLikeToArray(o, minLen);
                var n = Object.prototype.toString.call(o).slice(8, -1);
                if (n === 'Object' && o.constructor) n = o.constructor.name;
                if (n === 'Map' || n === 'Set') return Array.from(o);
                if (n === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return AllContent_arrayLikeToArray(o, minLen);
            }

            function AllContent_arrayLikeToArray(arr, len) {
                if (len == null || len > arr.length) len = arr.length;
                for (var i = 0, arr2 = new Array(len); i < len; i++) {
                    arr2[i] = arr[i];
                }
            ...
            function AllContent_iterableToArrayLimit(arr, i) {
                var _i = arr == null ? null : (typeof Symbol !== 'undefined' && arr[Symbol.iterator]) || arr['@@iterator'];
                if (_i == null) return;
                var _arr = [];
                var _n = true;
            ...
            function AllContent_arrayWithHoles(arr) {
                if (Array.isArray(arr)) return arr;
            }
            ...
            var AllContent = function AllContent() {
                ...
                var fetchData = /*#__PURE__*/ (function () {
                    var _ref = _asyncToGenerator(
                        /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(url, func) {
                ...
                (0, react.useEffect)(function () {
                    ...
                    var userData =
                        (_window = window) === null || _window === void 0 ? void 0 : (_window$data = _window.data) === null || _window$data === void 0 ? void 0 : _window$data.user;
                    setUserData(userData);
                    var url =
                        (_window2 = window) === null || _window2 === void 0
                            ? void 0
                            : (_window2$data = _window2.data) === null || _window2$data === void 0
                            ? void 0
                            : (_window2$data$content = _window2$data.contentHubAPI) === null || _window2$data$content === void 0
                            ? void 0
                            : _window2$data$content.search.allContent;
                    ...
                    if (url) {
                        ...
                        fetchData(
                            ''.concat(
                                window.globalData.urls.fb,
                                '?profile=search&collection=sug~sp-stanford-university-content-hub&num_ranks=10&start_rank=1&sort=dmetamtxCreated&&query=!nullquery',
                            ),
                            'fb',
                        );
                        setDataLocation('fb');
                ...
                return isLoading
                    ? /*#__PURE__*/ react.createElement(dist_module /* Oval */.iT, {
                          visible: true,
                          height: '80',
                          width: '80',
                          color: '#B1040E',
                          ...
                          /*#__PURE__*/ react.createElement(PageHeading /* PageHeading */.C, {
                              headingText:
                                  (_window3 = window) === null || _window3 === void 0
                                      ? void 0
                                      : (_window3$data = _window3.data) === null || _window3$data === void 0
                                      ? void 0
                                      : (_window3$data$texts = _window3$data.texts) === null || _window3$data$texts === void 0
                                      ? void 0
                                      : (_window3$data$texts$a = _window3$data$texts.allcontent) === null || _window3$data$texts$a === void 0
                                      ? void 0
                                      : _window3$data$texts$a.headingText,
                              subHeadingText:
                                  (_window4 = window) === null || _window4 === void 0
                                      ? void 0
                                      : (_window4$data = _window4.data) === null || _window4$data === void 0
                                      ? void 0
                                      : (_window4$data$texts = _window4$data.texts) === null || _window4$data$texts === void 0
                                      ? void 0
                                      : (_window4$data$texts$n = _window4$data$texts.newcontent) === null || _window4$data$texts$n === void 0
                                      ? void 0
                                      : _window4$data$texts$n.subHeadingText,
                              homeButton: true,
                          }),
                          ...
                          /*#__PURE__*/ react.createElement(
                              ...
                              /*#__PURE__*/ react.createElement(
                                  ...
                                  /*#__PURE__*/ react.createElement(
                                      ...
                                      resultsSummary.currStart,
                                      '-',
                                      resultsSummary.currEnd,
                                      ' of ',
                                      resultsSummary.totalMatching,
                                      ' results',
                                  ),
                                  /*#__PURE__*/ react.createElement(
                                      'div',
    ...
    /******/ var __webpack_exports__ = __webpack_require__.O(undefined, [736], function () {
        return __webpack_require__(3685);
    });
