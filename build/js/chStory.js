...
var StoryView = function StoryView() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              setData(d);
              _summary = (0,helperFunctions/* decodeHTML */.p1)(d.metadata.srcSummary[0] ? d.metadata.srcSummary[0] : 'N/A');
              setSummary(_summary);
  ...
  var clearReviewState = function clearReviewState(id) {
    ...
    setBeaconSent(false);
    window.addEventListener('unload', sendBeacon(id), {
      capture: true
    });
    window.addEventListener('beforeunload', sendBeacon(id), {
      capture: true
    });
    window.addEventListener('pagehide', sendBeacon(id), {
      capture: true
    });
  };
