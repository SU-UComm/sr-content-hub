...
var AppStateProvider = function AppStateProvider(props) {
  ...
  return /*#__PURE__*/react.createElement(AppStateContext.Provider, {
    value: state
  }, /*#__PURE__*/react.createElement(AppDispatchContext.Provider, {
    value: dispatch
  }, props.children));
};
...
function DataState_slicedToArray(arr, i) { return DataState_arrayWithHoles(arr) || DataState_iterableToArrayLimit(arr, i) || DataState_unsupportedIterableToArray(arr, i) || DataState_nonIterableRest(); }

function DataState_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function DataState_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return DataState_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return DataState_arrayLikeToArray(o, minLen); }

function DataState_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function DataState_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function DataState_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function DataState_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function DataState_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { DataState_ownKeys(Object(source), true).forEach(function (key) { DataState_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { DataState_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function DataState_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



var DataStateContext = /*#__PURE__*/react.createContext();
...
var DataStateProvider = function DataStateProvider(props) {
  var initialData = props.defaultData;

  var _React$useReducer = react.useReducer(dataStateReducer, initialData),
      _React$useReducer2 = DataState_slicedToArray(_React$useReducer, 2),
      state = _React$useReducer2[0],
      dispatch = _React$useReducer2[1];

  return /*#__PURE__*/react.createElement(DataStateContext.Provider, {
    value: state
  }, /*#__PURE__*/react.createElement(DataDispatchContext.Provider, {
    value: dispatch
  }, props.children));
};
...
var App = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return /*#__PURE__*/react.createElement(AppStateProvider, {
        defaultData: appStateDefaultData
      }, /*#__PURE__*/react.createElement(DataStateProvider, {
        defaultData: dataStateDefaultData
