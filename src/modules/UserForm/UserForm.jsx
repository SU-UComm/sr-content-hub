...
export const UserForm = () => {
    ...
    return (
        <>
            <p>
                ENV variable <i>process.env.ENV</i> === <strong>{`${process.env.ENV}`}</strong>
            </p>
            <form className="userForm" onSubmit={handleSubmit(onSubmit)}>
                {HandleFormErrors(errors)}

                <div className="userForm__field">
                    <label htmlFor="title" className="userForm__label">
                        Title
                    </label>
                    <select
                        id="title"
                ...
                <div className="userForm__field">
                    <label htmlFor="firstName" className="userForm__label">
                        First name
                    </label>
                    <input
                        id="firstName"
                ...
                <div className="userForm__field">
                    <label htmlFor="lastName" className="userForm__label">
                        Last name
                    </label>
                    <input
                        id="lastName"
                ...
                <div className="userForm__field">
                    <label htmlFor="email" className="userForm__label">
                        E-mail
                    </label>
                    <input
                        id="email"
                ...
                <div className="userForm__field">
                    <label htmlFor="mobilePhone" className="userForm__label">
                        Mobile number
                    </label>
                    <input
                        id="mobilePhone"
                ...
                <div className="userForm__field">
                    ...
                    />
                    <label htmlFor="Developer01" className="userForm__label userForm__label--inline">
                        I am a developer
                    </label>
                </div>
                ...
                <div className="userForm__field">
                    ...
                    />
                    <label htmlFor="Developer02" className="userForm__label userForm__label--inline">
                ...
                <div className="userForm__field">
                    <button type="submit" className="userForm__button userForm__submit">
                        Next step
                    </button>
                </div>
            </form>
