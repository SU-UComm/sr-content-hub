        ...
        <div className="su-flex-[calc(100%/3)_1_1]">
            ...
            <div className="undefined">
                <div className="c-select c-select--search su-min-w-full">
                    <select className="su-opacity-0 su-float-right su-border-0 su-w-0 su-h-0 su-p-0 su-m-0" name="f.contentPartner%7CtaxonomyContentPartnerText" id="cp-filter">
                        <option value="BeWell">BeWell</option>
                        <option value="Bill Lane Center for the American West">Bill Lane Center for the American West</option>
                        ...
                        <option value="Stanford Center for Innovation in Global Health">Stanford Center for Innovation in Global Health</option>
                    ...
                    <div className="c-wrapper su-relative su-group">
                        ...
                        <div className="su-z-10 su-hidden group-[.open]:su-block su-overflow-y-auto su-absolute su-border-t-0 su-border su-border-gray su-w-full su-bg-white su-rounded-b su-top-full">
                            ...
                            <ul className="su-z-10 c-list su-max-h-[209px] su-overflow-y-auto su-p-0 su-list-none">
                                ...
                                <li
                                    data-value="Bill Lane Center for the American West"
                                    role="button"
                                    className="su-leading-[3.6rem] su-block su-text-18 su-mb-0 su-py-8 su-pl-15 su-pr-20 hover:su-cursor-pointer hover:su-bg-gray-light"
                                    tabIndex="-1"
                                >
                                ...
                                <li
                                    data-value="Stanford Center for Innovation in Global Health"
                                    role="button"
                                    className="su-leading-[3.6rem] su-block su-text-18 su-mb-0 su-py-8 su-pl-15 su-pr-20 hover:su-cursor-pointer hover:su-bg-gray-light"
                                    tabIndex="-1"
                                >
